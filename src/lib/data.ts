...
const rawPlayers = [
  ...
  { name: "Vlad Vidican", rating: 4.190, pace: 80, sho: 80, pas: 80, dri: 80, def: 80, phy: 80, attendance: 100, winRate: 75, cups: 2, history: [0, 0, 0, 3.65, 3.786, 4.190] },
  ...
  { name: "Zamfirescu Adrian", rating: 3.520, pace: 80, sho: 80, pas: 80, dri: 80, def: 80, phy: 80, attendance: 67, winRate: 75, cups: 1, history: [4.2, 3.9, 3.7, 3.5, 3.45, 3.520] },
  ...
  { name: "Borfina Marius", rating: 3.305, pace: 80, sho: 80, pas: 80, dri: 80, def: 80, phy: 80, attendance: 100, winRate: 75, cups: 2, history: [0, 3.5, 3.25, 3.35, 3.35, 3.305] },
...
export const trophies = [
  ...
  { name: "Vlad Vidican", cups: 2, rate: "75%", successRate: "75%" },
  { name: "Borfina Marius", cups: 2, rate: "75%", successRate: "75%" },
  { name: "Ovidiu Moldovan", cups: 2, rate: "100%", successRate: "100%" },
  { name: "Alexandru Avirvarei", cups: 1, rate: "58%", successRate: "58%" },
  { name: "Zamfirescu Adrian", cups: 1, rate: "75%", successRate: "75%" },
