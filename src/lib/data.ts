...
const rawPlayers = [
  { name: "Termure Adrian", rating: 4.729, pace: 80, sho: 80, pas: 80, dri: 80, def: 80, phy: 80, attendance: 67, winRate: 50, cups: 1, history: [4.9, 4.84, 4.64, 4.63, 4.53, 4.729] },
  { name: "Gabriel Marzan", rating: 4.614, pace: 80, sho: 80, pas: 80, dri: 80, def: 80, phy: 80, attendance: 33, winRate: 100, cups: 1, history: [4.53, 4.73, 4.64, 4.63, 4.635, 4.614] },
  { name: "Florin Ispas", rating: 4.6, pace: 80, sho: 80, pas: 80, dri: 80, def: 80, phy: 80, attendance: 0, winRate: 0, cups: 0, history: [4.63, 4.66, 4.56, 4.65, 4.725, 4.6] },
  { name: "Burz Radu", rating: 4.514, pace: 80, sho: 80, pas: 80, dri: 80, def: 80, phy: 80, attendance: 33, winRate: 25, cups: 0.25, history: [4.85, 4.84, 4.68, 4.56, 4.565, 4.514] },
  { name: "Silviu Bahrin", rating: 4.329, pace: 80, sho: 80, pas: 80, dri: 80, def: 80, phy: 80, attendance: 100, winRate: 100, cups: 3, history: [0, 0, 0, 3.96, 4.06, 4.329] },
  { name: "Paul Epure", rating: 4.271, pace: 80, sho: 80, pas: 80, dri: 80, def: 80, phy: 80, attendance: 67, winRate: 50, cups: 1, history: [0, 0, 3.72, 4.08, 4.29, 4.271] },
  { name: "Vlad Vidican", rating: 4.179, pace: 80, sho: 80, pas: 80, dri: 80, def: 80, phy: 80, attendance: 100, winRate: 75, cups: 2.25, history: [0, 0, 0, 3.65, 3.786, 4.179] },
  ...
  { name: "Codrin Aghirasimoaei", rating: 3.850, pace: 80, sho: 80, pas: 80, dri: 80, def: 80, phy: 80, attendance: 0, winRate: 0, cups: 0, history: [0, 4.4, 4.22, 4.08, 0, 3.85] },
  ...
  { name: "Cristian Borlea", rating: 3.780, pace: 80, sho: 80, pas: 80, dri: 80, def: 80, phy: 80, attendance: 0, winRate: 0, cups: 0, history: [4.4, 4.15, 3.92, 3.9, 4.0, 3.78] },
  { name: "Adrian Ispas", rating: 3.770, pace: 80, sho: 80, pas: 80, dri: 80, def: 80, phy: 80, attendance: 0, winRate: 0, cups: 0, history: [0, 0, 4.08, 3.9, 3.85, 3.77] },
  { name: "Andries Adrian", rating: 3.740, pace: 80, sho: 80, pas: 80, dri: 80, def: 80, phy: 80, attendance: 33, winRate: 100, cups: 1, history: [0, 0, 0, 0, 3.65, 3.74] },
  { name: "Ovidiu Iancau", rating: 3.700, pace: 80, sho: 80, pas: 80, dri: 80, def: 80, phy: 80, attendance: 0, winRate: 0, cups: 0, history: [0, 0, 0, 3.8, 3.8, 3.7] },
  { name: "Ionut Moldovan", rating: 3.693, pace: 80, sho: 80, pas: 80, dri: 80, def: 80, phy: 80, attendance: 33, winRate: 25, cups: 0.25, history: [0, 0, 0, 0, 3.85, 3.693] },
  { name: "Denis Antonie", rating: 3.610, pace: 80, sho: 80, pas: 80, dri: 80, def: 80, phy: 80, attendance: 0, winRate: 0, cups: 0, history: [0, 4.15, 0, 3.84, 0, 3.61] },
  { name: "Balau George", rating: 3.255, pace: 80, sho: 80, pas: 80, dri: 80, def: 80, phy: 80, attendance: 0, winRate: 0, cups: 0, history: [0, 0, 0, 0, 3.45, 3.255] },
  { name: "Gabi Trofin", rating: 3.150, pace: 80, sho: 80, pas: 80, dri: 80, def: 80, phy: 80, attendance: 33, winRate: 100, cups: 1, history: [0, 0, 0, 3.5, 3.425, 3.15] },
  { name: "Vasi Trif", rating: 2.867, pace: 80, sho: 80, pas: 80, dri: 80, def: 80, phy: 80, attendance: 33, winRate: 100, cups: 1, history: [0, 0, 0, 0, 2.9, 2.867] },
  { name: "Muresan Cosmin", rating: 2.580, pace: 80, sho: 80, pas: 80, dri: 80, def: 80, phy: 80, attendance: 0, winRate: 0, cups: 0, history: [0, 0, 0, 0, 0, 2.58] },
  { name: "Alexandru Avirvarei", rating: 3.570, pace: 80, sho: 80, pas: 80, dri: 80, def: 80, phy: 80, attendance: 100, winRate: 58, cups: 1.75, history: [4.05, 3.72, 3.64, 3.62, 3.55, 3.57] },
  { name: "Zamfirescu Adrian", rating: 3.520, pace: 80, sho: 80, pas: 80, dri: 80, def: 80, phy: 80, attendance: 67, winRate: 75, cups: 1.5, history: [4.2, 3.9, 3.7, 3.5, 3.45, 3.52] },
  ...
  { name: "Nedisan Vlad", rating: 3.080, pace: 80, sho: 80, pas: 80, dri: 80, def: 80, phy: 80, attendance: 100, winRate: 42, cups: 1.25, history: [0, 3.64, 3.35, 3.25, 3.22, 3.08] },
  { name: "Ovidiu Moldovan", rating: 3.050, pace: 80, sho: 80, pas: 80, dri: 80, def: 80, phy: 80, attendance: 67, winRate: 100, cups: 2, history: [0, 0, 3.32, 3.15, 3.12, 3.05] },
  { name: "Mihai Pop", rating: 3.040, pace: 80, sho: 80, pas: 80, dri: 80, def: 80, phy: 80, attendance: 67, winRate: 50, cups: 1, history: [0, 0, 0, 3.25, 3.12, 3.04] },
  { name: "Florin Dusa", rating: 3.010, pace: 80, sho: 80, pas: 80, dri: 80, def: 80, phy: 80, attendance: 33, winRate: 0, cups: 0, history: [0, 3.65, 0, 3.3, 3.1, 3.01] },
