...
import { Award, Star, History, Zap, Trophy } from "lucide-react";
      ...
      <div className="mx-auto max-w-4xl px-4 pt-6">
        ...
        <div className="mt-16 grid grid-cols-1 gap-8 md:grid-cols-2">
          <section>
            ...
            <div className="rounded-xl bg-white/[0.03] p-4 border border-white/10 backdrop-blur-md shadow-2xl">
                ...
                {trophies.slice(0, 5).map((t, i) => (
                  <div key={i} className="flex items-center justify-between rounded-lg bg-white/[0.02] p-3 border border-white/5 transition-colors hover:border-emerald-500/20">
                    ...
                    <div className="flex items-center gap-1.5">
                      ...
                      <span className="text-[9px] font-bold text-neutral-500 uppercase">PTS</span>
                    </div>
                  </div>
                ))}
              </div>
